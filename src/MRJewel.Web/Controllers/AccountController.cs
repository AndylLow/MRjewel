...
using MRJewel.Sessions;
using MRJewel.Web.Controllers.Results;
using MRJewel.Web.Models;
using MRJewel.Web.Models.Account;
...
{
    public class AccountController : MRJewelControllerBase
    {
